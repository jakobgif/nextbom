...
A SQLite database containing the mapping from generic part IDs (like `CAP00100`) to manufacturer part numbers. This is a shared resource across all your projects — it's the central repository of parts and is linked to your project. You create and manage this file separately; it is not auto-generated by nextbom.

Multiple projects can share the same `.nextdb` file, or each project can use a different one. You can change which parts database is linked to a project at any time.
